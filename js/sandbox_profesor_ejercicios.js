$(document).ready(function() {
    ...
    $.getJSON("../../../../data/profesores_sandbox/ejercicios.json", function(data) {
        ...
        $.each(estadisticas, function(key, value){
            ...
            var boxContentProgress = $('<div class="progress"><div class="progress-bar" style="width: ' + value.porcentajeAportado + '%"></div></div><span class="progress-description">' + value.porcentajeAportado + '% aportado</span>');
        ...
        $.each(lista, function(key, value){
            ...
            $.each(listaNivel, function(key, value){
                ...
                var td3 = $('<td><span class="badge ' + estadisticas[i].color + '">' + nivel + '</span></td>'); 
                tr.append(td1);
                tr.append(td2);
                tr.append(td3);
