$(document).ready(function() {
    ...
    $.getJSON("../../../../../data/profesores_sandbox/ejercicio.json", function(data) {
        var tituloData = data.titulo;
        var descripcionData = data.descripcion;
        var etiquetasData = data.etiquetas;
        var dificultadData = data.dificultad;
        var titulo = $("#titulo");
        console.log(tituloData);
        titulo.val(tituloData);
        var descripcion = $("#descripcion");
        descripcion.text(descripcionData);
        var divEtiquetasAgregadas = $("#etiquetas-agregadas");
        var dificultad = $("#dificultad");
        var divEtiquetasAgregadas = $("#etiquetas-agregadas");
        dificultad.val(dificultadData);
        $.each(etiquetasData, function(key, value) {
            var etiqueta = value.nombre;
